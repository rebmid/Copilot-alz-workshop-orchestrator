...
class IntentOrchestrator:
    ...
    def run_intents(
        ...
        *,
        ...
        """Run multiple intents sequentially, sharing the signal cache."""
        return [
            self.run_intent(
                iid, scope,
                run_id=run_id,
    ...
    def evaluate_intent(
        ...
        *,
        ...
        """Evaluate intent without any AI — pure deterministic."""
        return self.runtime.execute_intent(
            intent_id, scope, run_id=run_id, verbose=verbose,
        )
