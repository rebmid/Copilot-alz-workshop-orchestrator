...
from signals.types import ControlResult, EvalContext, EvalScope, SignalResult
...
def evaluate_control(
    ...
    *,
    ...
    events = bus.reset_events()
    cache_hit = all(e.get("cache_hit", False) for e in events if e["type"] == "signal_returned")
